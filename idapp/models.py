...
class Student(models.Model):
    ...
    def __str__(self):
        return str(f"{self.student_code} - {self.first_name} "+ (f"{self.middle_name} {self.last_name}" if not self.middle_name == "" else f"{self.last_name}") )
    def name(self):
